...
*(E1:S04:T03–T06 archived — [kanban-completed.md](kanban-completed.md).)*

- **E1:S04:T07** – FR-099 Phase 4 — Rewire & verify - 📋 TODO (CRITICAL, remotes/badges/install smoke; public live at [earlution/ai-dev-kit](https://github.com/earlution/ai-dev-kit)) - [T07](epics/Epic-1/Story-004-repository-branding-and-renaming/T07-fr099-phase4-rewire-and-verify.md) | [FR-099](fr-br/FR-099-spin-off-book-epic-to-private-repository.md) | [—IPP—](../../implementation-cycles/IPP-E1S04-fr099-book-private-public-migration.md) | Last modified: 2026-05-26 16:02 UTC
