...
**Last Updated:** 2026-05-20 (RW v0.4.13.7+1 — E4:S13:T07 MoSCOW state icons UXR-012)
**Version Context:** v0.4.13.7+1 (**SemVer** v0.4.796+1)
...
- **FR-097** – Board stamp authority, blocking validation, and forensic timestamp recovery - ✅ RESOLVED (v0.2.15.8+1) | [FR-097](fr-br/FR-097-board-stamp-authority-and-forensic-timestamp-recovery.md) | [E2:S15:T08](epics/Epic-2/Story-015-ipw-governance-and-publication-contract/T08-board-stamp-authority-forensic-timestamp-recovery-fr097.md) | [—IPP—](../../implementation-cycles/IPP-E2S15T08-board-stamp-authority-forensic-timestamp-recovery.md) | Last modified: 2026-05-20 18:30 UTC
...
- **BR-067** – RW doc-only / intake releases default to BUILD+1 instead of doc-init +0 - 🟢 OPEN (HIGH, versioning policy vs validate_version_bump / RW Step 2 defaults; **E2:S16:T03**) | [BR-067](fr-br/BR-067-rw-first-doc-only-release-defaults-to-build-plus-one-not-plus-zero.md) | [E2:S16:T03](epics/Epic-2/Story-016-perpetual-ongoing-workflow-operations/T03-rehouse-workflow-perpetual-tasks-and-harden-guardrails.md) | —No IPP— | Last modified: 2026-04-19 00:00 UTC
...
- **FR-008** – Package Uninstall Capabilities - 📋 TODO (LOW, Uninstall capabilities for packages) | [FR-008](fr-br/FR-008-package-uninstall-capabilities.md) | [E2:S06:T01](epics/Epic-2/Story-006-package-uninstall-and-recovery.md) | —No IPP— | Last modified: 2026-05-15 00:00 UTC
