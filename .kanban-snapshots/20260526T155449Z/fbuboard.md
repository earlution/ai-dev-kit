...
**Last Updated:** 2026-05-26 (FR-099 → Must Have)
**Version Context:** v0.1.4.7+1 (**SemVer** v0.4.811+1)
...
- **FR-099** – Spin off book epic to a private repository - 🔄 IN PROGRESS (CRITICAL, phases **T03–T05** ✅ · **T06** public rebirth · **T07** rewire; one task per phase on [kboard](kboard.md)) | [FR-099](fr-br/FR-099-spin-off-book-epic-to-private-repository.md) | [Story 004](epics/Epic-1/Story-004-repository-branding-and-renaming.md) | [ADR-006](../../architecture/standards-and-adrs/ADR-006-book-project-private-repository-spin-off.md) | [—IPP—](../../implementation-cycles/IPP-E1S04-fr099-book-private-public-migration.md) | Last modified: 2026-05-26 16:20 UTC
