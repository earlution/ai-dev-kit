...
def resolve_kanban_paths(
    ...
    if config and config.get('use_kanban') and 'kanban_root' in config:
        ...
        kanban_root = project_root / "docs/Project_Management/kanban"
    ...
    if config and config.get('use_kanban') and 'epic_doc_pattern' in config:
        ...
        # Default fallback patterns
        epic_patterns = [
            project_root / f"docs/Project_Management/epics/overview/Epic {epic}/Epic-{epic}.md",
            project_root / f"docs/Project_Management/kanban/epics/Epic-{epic}/Epic-{epic}.md",
        ]
        epic_doc = None
    ...
    if config and config.get('use_kanban') and 'kanban_board' in config:
        ...
        board_patterns = [
            ...
            project_root / "docs/Project_Management/kanban/kanban-board.md",
        ]
