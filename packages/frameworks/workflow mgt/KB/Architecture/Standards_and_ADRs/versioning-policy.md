...
- Additional changes
- See [CHANGELOG_v0.20.11.4+1.md](docs/Changelog_and_Release_Notes/Changelog_Archive/CHANGELOG_v0.20.11.4+1.md)
```
...
- **[Kanban Governance Policy](../../Project_Management/rituals/policy/kanban-governance-policy.md)** - Work item structure (Epic → Story → Task) and how they map to version schema
...
- **Changelog Archive:** `docs/Changelog_and_Release_Notes/Changelog_Archive/` - Detailed changelog files
