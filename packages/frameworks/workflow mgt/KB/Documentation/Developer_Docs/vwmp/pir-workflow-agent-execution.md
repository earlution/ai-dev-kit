...
# Story-level example
Story document: docs/Project_Management/kanban/epics/Epic-{N}/Story-{N}-{name}.md
```
...
```bash
# Epic-level
Epic: docs/Project_Management/kanban/epics/Epic-{N}/Epic-{N}.md

# Story-level
Story: docs/Project_Management/kanban/epics/Epic-{N}/Story-{N}-{name}.md
```

**C.2. Read Story/Task Documents:**
```bash
# For Epic-level: Read all Stories
Stories: docs/Project_Management/kanban/epics/Epic-{N}/Story-*.md

# For Story-level: Read all Tasks
Tasks: docs/Project_Management/kanban/epics/Epic-{N}/Story-{N}-*/Task-*.md
```
...
docs/Changelog_and_Release_Notes/Changelog_Archive/CHANGELOG_v{version}.md
```
...
- Add link to Epic/Story document:
  - Epic: `[Epic {N} Documentation](../../Project_Management/kanban/epics/Epic-{N}/Epic-{N}.md)`
  - Story: `[Story {N} Documentation](../../Project_Management/kanban/epics/Epic-{N}/Story-{N}-{name}.md)`
