...
```bash
# Read Epic document
Epic: docs/Project_Management/kanban/epics/Epic-2/Epic-2.md
Status: COMPLETE ✅
Review Level: Epic
```
...
- **Epic:** [Epic 2 Documentation](../../Project_Management/kanban/epics/Epic-2/Epic-2.md) (v0.2.11.9+3)
...
**Step 1: Identify Review Scope**
```bash
Story: docs/Project_Management/kanban/epics/Epic-2/Story-5-*.md
Status: COMPLETE ✅
Review Level: Story
```
