...
python3 detect_existing_structure.py \
  --kanban-path docs/Project_Management/kanban \
...
1. **Detect existing structure:**
   ```bash
   python3 detect_existing_structure.py --kanban-path docs/Project_Management/kanban --output detection_report.json
   ```
