...
Arguments:
    ...
    --backup-dir DIR          Directory for backups (default: docs/Project_Management/kanban/_backup-{timestamp})
...
class KanbanStructureMigrator:
    ...
    def _update_task_references(self) -> Dict:
        ...
        project_root = self.kanban_path.parent.parent.parent  # Go up from docs/Project_Management/kanban
    ...
    def _get_project_name(self) -> str:
        ...
        # If kanban_path is like "docs/Project_Management/kanban", try to get repo root
