...
- BR document is created in `docs/Project_Management/kanban/fr-br/`
...
- FR document is created in `docs/Project_Management/kanban/fr-br/`
- Issue is commented with document link
...
- UXR document is created in `docs/Project_Management/kanban/fr-br/`
- Issue is commented with document link
...
3. **Document Creation:** A new document is created in `docs/Project_Management/kanban/fr-br/`
...
1. **Check Path:** Documents are in `docs/Project_Management/kanban/fr-br/`
