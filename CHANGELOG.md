...
E2:S15:T01 — hardened IPW publication contract and discoverability wiring for planning artifacts with deterministic validation, regression tests, and backfill inventory. SemVer **v0.4.739+1**.

[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.2.15.1+1.md)
