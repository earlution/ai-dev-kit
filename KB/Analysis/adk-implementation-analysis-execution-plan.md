...
1. **Scan All Projects** (`/Users/rms/Documents/projects`)
   - Look for ADK indicators:
     - `KB/` directory
     - `KB/PM_and_Portfolio/kanban/` structure
...
- `been-there/` (has KB/, version.py)
- `starborn_legacy/` (has KB/, CHANGELOG.md)
- `confidentia/` (has KB/PM_and_Portfolio/kanban/)
- `dev-toolkit/` (has KB/, packages/, rw-config.yaml)
