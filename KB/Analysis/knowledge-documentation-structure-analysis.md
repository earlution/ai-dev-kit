...
**Purpose:** Comprehensive knowledge base and documentation structure analysis across all projects to inform the "ultimate" canonical KB/documentation structure  
...
This document provides **detailed knowledge/documentation structure analysis** of KB and documentation patterns across all analyzed projects. Without this granular data, we cannot determine the "ultimate" canonical KB/documentation structure.

**Key Questions Addressed:**
1. What KB/documentation naming conventions exist across projects?
2. How are KB/documentation directories organized (structure patterns)?
...
## 1. KB/Documentation Directory Naming Conventions

### 1.1 Root Directory Naming Patterns

**Pattern 1: `KB/` (Most Common)**
...
- **Rationale:** Standard convention, often used alongside `KB/`

### 1.2 Directory Naming Summary

| Project | Primary KB Root | Secondary Docs | Notes |
|---------|----------------|----------------|-------|
| been-there | `KB/` | None | Standard ADK structure |
| fynd.deals | `knowledge/fynd_deals/` | `docs/fynd_deals/` | Pre-ADK, Obsidian-oriented |
| dev-toolkit | `KB/` | None | Standard ADK structure |
| agentic-ide-rules | `KB/` | None | Standard ADK structure |
| confidentia | `KB/` | `knowledge_restored/knowledge/` (branch 21) | Multi-branch, legacy preservation |
| starborn_legacy | `KB/` | `docs/` | Dual structure |
| free-party-promoter | `KB/` | None | Standard ADK structure |
| vwmp | `KB/` | None | Standard ADK structure |
| qa-kb | `KB/` | `docs/` | Minimal structure |
| ai-dev-kit | `KB/` | None | Canonical structure |

**Recommendation:** Use `KB/` as canonical root directory name.
...
- **Changelog_and_Release_Notes:** Release notes, changelogs, version history
- **PM_and_Portfolio:** Kanban, governance, rituals, epics/stories
...
├── Engineering_and_Platform/         # Engineering standards
...
**Recommended:** `KB/` (uppercase, abbreviation)
...
- Templates in KB structure: `KB/PM_and_Portfolio/kanban/templates/`
...
## 10. Summary: "Ultimate" Canonical KB/Documentation Structure

### 10.1 Root Directory
- **Name:** `KB/` (uppercase, abbreviation)
...
- **Legacy:** Support hybrid structure (`KB/` + `docs/`) during migration
...
**Next Steps:** Use this analysis to finalize canonical KB/documentation structure in ADK frameworks
