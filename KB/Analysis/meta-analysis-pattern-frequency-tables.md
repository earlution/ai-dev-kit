...
## 2. KB/Documentation Directory Naming Frequencies

### 2.1 Root Directory Naming

| Directory Name | Projects Using | Frequency | Notes |
|---------------|----------------|-----------|-------|
| `KB/` (uppercase) | been-there, dev-toolkit, agentic-ide-rules, confidentia, starborn_legacy, free-party-promoter, vwmp, qa-kb, ai-dev-kit | 10/10 (100%) | Universal convergence |
...
**Convergence:** `KB/` is universal (10/10 = 100%), indicating perfect convergence on ADK canonical naming.
...
| Hybrid (KB + docs) | starborn_legacy, free-party-promoter, vwmp, qa-kb | 4/10 (40%) | `KB/` + `docs/` dual structure |
...
|---------|-----------|--------|
| `KB/` directory naming | 10/10 (100%) | ✅ Perfect convergence |
...
- **`KB/` directory naming:** Universal (10/10 = 100%)
...
1. **Enforce `KB/` naming:** Already universal, maintain as canonical
