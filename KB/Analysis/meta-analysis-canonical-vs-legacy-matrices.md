...
## 2. KB/Documentation Structure: Canonical vs Legacy Matrix

### 2.1 Root Directory Comparison

| Aspect | ADK Canonical | Real-World Pattern | Gap/Over-Engineering | Legacy Support Needed |
|--------|---------------|-------------------|---------------------|----------------------|
| **Root Directory** | `KB/` (uppercase) | `KB/` (100%) | ✅ Perfect - Universal convergence | ✅ Yes - Support `knowledge/` for pre-ADK |
| **Secondary Docs** | None | `docs/` (33%), `knowledge/` (22%) | ⚠️ Gap: Support dual structure | ✅ Yes - Support `KB/` + `docs/` hybrid |
| **Directory Naming** | Uppercase `KB/` | `KB/` (100%) | ✅ Perfect - Universal convergence | ❌ No - `KB/` is universal |

**Key Findings:**
- **Gap:** Need to support dual structure (`KB/` + `docs/`) for migration
...
| `knowledge/` directory | 22% | ✅ Support `KB/` and `knowledge/` during migration |
| `docs/` secondary directory | 33% | ✅ Support `KB/` + `docs/` hybrid structure |
...
2. **KB Structure Flexibility**
   ...
   - Support `KB/` + `docs/` hybrid structure
