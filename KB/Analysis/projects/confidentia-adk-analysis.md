...
- **Directory Structure:** `KB/PM_and_Portfolio/kanban/Epic X/` (with space, not hyphen)
...
- Structure: `KB/PM_and_Portfolio/kanban/Epic X/Story-X.md`
...
- **Directory Structure:** `KB/` with many more pillars than ADK canonical
...
**Comparison to ADK Canonical:**
- ADK Canonical: 5 pillars (Architecture, Changelog, Documentation, Guides, PM_and_Portfolio)
...
- **Additional Pillars:** Customer_Enablement, Data_and_Insights, Engineering_and_Platform, Governance_and_Process, Monitoring_and_Observability, Onboarding_and_Enablement, Operations_and_SRE, Product_and_Experience, Security_and_Compliance, Testing, Tooling_and_Integrations
...
- **Root Path:** `knowledge_restored/knowledge/` (separate from KB/)
...
**Kanban Files:**
- `KB/PM_and_Portfolio/kanban/Epic X/` (Epics 1-22, with space in directory name)
- Multiple stories per epic
- Tasks embedded in stories

**KB Files:**
- `KB/Architecture/` (C4 model views, specs, ADRs)
- `KB/Changelog_and_Release_Notes/`
- `KB/Documentation/`
- `KB/Governance_and_Process/`
- `KB/Operations_and_SRE/`
- `KB/Security_and_Compliance/`
- `KB/Testing/`
- `KB/Tooling_and_Integrations/`
- Many other pillars
