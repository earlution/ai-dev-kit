...
- **Directory Structure:** `docs/Epic-10.md` and `docs/epic-10-legacy/` (not in KB/PM_and_Portfolio/)
...
- But structure is in `docs/` not `KB/PM_and_Portfolio/kanban/epics/`
...
- **Difference:** Uses `docs/` instead of `KB/PM_and_Portfolio/kanban/epics/`
...
- **Impact:** Major - incompatible with ADK tools expecting KB/PM_and_Portfolio/kanban/ structure
...
1. **Different Structure Location**
   - **Issue:** Uses `docs/` instead of `KB/PM_and_Portfolio/kanban/epics/`
...
**For This Project:**
1. **Consider KB Structure Migration** - Evaluate migrating to `KB/PM_and_Portfolio/kanban/epics/` structure
...
1. **Support Different Structure Locations**
   ...
   - Support both `docs/` and `KB/PM_and_Portfolio/kanban/epics/` paths
...
- **Directory Structure:** No KB/ directory (uses `docs/` instead)
...
**Comparison to ADK Canonical:**
- ADK Canonical: KB/PM_and_Portfolio/kanban/epics/ structure
...
- **Root Path:** No `KB/` directory (uses `docs/` instead)
- **Structure:** Flat structure vs nested KB structure
- **Missing:** No KB/PM_and_Portfolio/kanban/ structure
...
- **KB:** **MAJOR** (no KB/ directory, uses docs/)
...
1. **Assuming KB Structure**
   - **Anti-Pattern:** Assuming all projects use KB/PM_and_Portfolio/kanban/ structure
...
- Minimal structure (docs/ instead of KB/)
- Good migration documentation
...
**KB Files:**
- No KB/ directory (uses docs/ instead)
...
| File Organization | KB/PM_and_Portfolio/kanban/epics/ | docs/ (flat structure) | ⚠️ MAJOR DIVERGENCE |

**KB Structure Comparison:**

| Aspect | ADK Canonical | qa-kb | Match? |
|--------|---------------|-------|--------|
| Root Path | KB/ | docs/ (no KB/) | ⚠️ MAJOR DIVERGENCE |
