...
- **Directory Structure:** `KB/PM_and_Portfolio/epics/overview/Epic X/` (with space, not hyphen)
...
- Structure: `KB/PM_and_Portfolio/epics/overview/Epic X/E2S1-Description.md`
...
- **Directory Structure:** `KB/` with very comprehensive structure (similar to confidentia)
...
**Kanban Files:**
- `KB/PM_and_Portfolio/epics/overview/Epic X/` (Epics 1-6, with space in directory name)
...
- `KB/Playtesting/` (Game-specific)
- `KB/Research/` (Game-specific)
