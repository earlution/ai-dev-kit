...
- **Directory Structure:** `KB/PM_and_Portfolio/epics/overview/Epic 01/` (with space and zero-padding)
...
- Structure: `KB/PM_and_Portfolio/epics/overview/Epic 01/Story-1-Description.md`
...
- **Directory Structure:** `KB/` with minimal structure
- **Document Count:** ~50+ documents
- **Document Types:** Architecture, Documentation, PM_and_Portfolio
...
- vwmp: 3 pillars (Architecture, Documentation, PM_and_Portfolio) - minimal structure
...
**Kanban Files:**
- `KB/PM_and_Portfolio/epics/overview/Epic 01/` (Epic 01 only, with space and zero-padding)
- 4 stories
- Tasks embedded in stories

**KB Files:**
- `KB/Architecture/` (C4 model views, ADRs)
- `KB/Documentation/`
