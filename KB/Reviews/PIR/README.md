...
1. **Epic-Level PIR:**
   ...
   - **Location:** `KB/Reviews/PIR/Epic-{N}/`
...
2. **Story-Level PIR:**
   ...
   - **Location:** `KB/Reviews/PIR/Story-{N}/`
...
1. **Use Templates:**
   - Epic PIR: `KB/Documentation/Templates/epic-pir-template.md`
   - Story PIR: `KB/Documentation/Templates/story-pir-template.md`
...
_This directory is part of the Knowledge Base. See `KB/README.md` for complete KB structure._
