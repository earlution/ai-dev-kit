...
VERSION_EPIC = 4      # Epic number (Epic 4: Kanban/FBU governance)
VERSION_STORY = 19    # Story number within epic
VERSION_TASK = 3      # Task number (E4:S19:T03 — E6:S07 default-housing drift IPP publication)
VERSION_BUILD = 1     # Build number (RW -d E4:S19:T03 --art: IPP publication and wiring)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.4.19.3+1 = Development, Epic 4, Story 19, Task 3, Build 1
