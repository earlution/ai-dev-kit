...
VERSION_TASK = 2      # Task number (Task 2: Investigate proper package management)
VERSION_BUILD = 1     # Build number (E6:S06:T02+1 - Package management investigation complete)
