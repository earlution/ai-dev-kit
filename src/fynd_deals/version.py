...
VERSION_TASK = 2      # Task number (T02: Version and changelog alignment)
VERSION_BUILD = 0     # Build number (E7:S06:T02+0 – doc-init)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.7.6.2+0 = Development, Epic 7, Story 6, Task 2 (E7:S06:T02+0: Version and changelog alignment doc-init)
