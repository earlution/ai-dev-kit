...
VERSION_TASK = 12     # Task number (T12: Review CMW workflow Windsurf impact)
VERSION_BUILD = 1     # Build number (E7:S06:T12+1 – kanban doc init)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.7.6.12+1 = Development, Epic 7, Story 6, Task 12 (E7:S06:T12+1: Review CMW workflow kanban init)
