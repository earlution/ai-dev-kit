...
VERSION_TASK = 1      # Task number (Task 1: Create framework update procedures)
VERSION_BUILD = 1     # Build number (E6:S02:T01+1 - Framework update procedures document created)
