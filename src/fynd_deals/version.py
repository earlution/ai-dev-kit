...
VERSION_BUILD = 0     # Build number (E4:S18:T02+0 - Task document created, doc-init)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.4.18.2+0 = Development, Epic 4, Story 18, Task 2, Build 0 (Task document created, doc-init)
