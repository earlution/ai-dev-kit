...
VERSION_TASK = 1      # Task number (Task 1: CLI tool architecture and base structure)
VERSION_BUILD = 1     # Build number (E6:S07:T01+1 - CLI tool architecture and base structure complete)
