...
VERSION_BUILD = 5     # Build number (E5:S08:T02+5 - KB migration log, stub sweep MCP args)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.5.8.2+5 = Development, Epic 5, Story 8, Task 2, Build 5 (E5:S08:T02: KB migration log, stub sweep MCP args)
