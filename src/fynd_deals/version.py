...
VERSION_TASK = 7      # Task number (T07: General documentation and cross-reference integrity)
VERSION_BUILD = 1     # Build number (E7:S06:T07+1 – RW)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.7.6.7+1 = Development, Epic 7, Story 6, Task 7 (E7:S06:T07+1: General documentation and cross-reference integrity)
