...
VERSION_TASK = 4      # Task number (E2:S15:T04 — BR-069 re-housing and overwrite-regression investigation)
VERSION_BUILD = 1     # Build number (RW E2:S15:T04 --art)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.2.15.4+1 = Development, Epic 2, Story 15, Task 4, Build 1
