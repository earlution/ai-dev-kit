...
VERSION_BUILD = 2     # Build number (E6:S07:T103+2 - FR-042 IPW, planning docs)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.6.7.103+2 = Development, Epic 6, Story 7, Task 103, Build 2 (E6:S07:T103: FR-042 IPW)
