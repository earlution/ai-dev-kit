...
VERSION_TASK = 15     # Task number (T15: Review Intake workflow Windsurf impact)
VERSION_BUILD = 1     # Build number (E7:S06:T15+1 – kanban doc init)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.7.6.15+1 = Development, Epic 7, Story 6, Task 15 (E7:S06:T15+1: Review Intake workflow kanban init)
