...
VERSION_TASK = 12     # Task number (Task 12: Test PIR workflow with sample Epic)
VERSION_BUILD = 1     # Build number (E2:S05:T12+1 - PIR workflow tested end-to-end, all steps successful)
