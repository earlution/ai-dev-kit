...
VERSION_TASK = 1      # Task number (E2:S16:T01 — canonical perpetual ongoing tasks story)
VERSION_BUILD = 2     # Build number (RW -d E2:S16:T01 --art)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.2.16.1+2 = Development, Epic 2, Story 16, Task 1, Build 2
