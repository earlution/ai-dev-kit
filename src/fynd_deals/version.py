...
VERSION_TASK = 44     # Task number (T44: FR-044 RW execution log)
VERSION_BUILD = 1     # Build number (E5:S01:T44+1 - FR-044 task creation)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.5.1.44+1 = Development, Epic 5, Story 1, Task 44, Build 1 (E5:S01:T44: FR-044 task creation)
