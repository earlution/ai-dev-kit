...
VERSION_BUILD = 4     # Build number (RW E2:S16:T01 --art: AC/requirements traceability reconciliation publish)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.2.16.1+4 = Development, Epic 2, Story 16, Task 1, Build 4
