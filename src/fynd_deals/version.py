...
VERSION_TASK = 2      # Task number (E2:S15:T02 — IPW post-run governance reconciliation ownership)
VERSION_BUILD = 1     # Build number (RW E2:S15:T02 --art)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.2.15.2+1 = Development, Epic 2, Story 15, Task 2, Build 1
