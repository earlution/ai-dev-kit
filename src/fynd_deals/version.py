...
VERSION_TASK = 9      # Task number (T09: BR-060 kanban traceability / E2:S01 reopen)
VERSION_BUILD = 2     # Build number (E2:S01:T09+2 – RW)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.2.1.9+2 = Development, Epic 2, Story 1, Task 9 (E2:S01:T09+2: board timestamp governance + enforcement)
