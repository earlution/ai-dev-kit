...
VERSION_TASK = 7      # Task number (T07: General documentation integrity)
VERSION_BUILD = 0     # Build number (E7:S06:T07+0 – doc-init)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.7.6.7+0 = Development, Epic 7, Story 6, Task 7 (E7:S06:T07+0: General docs integrity doc-init)
