...
VERSION_TASK = 1      # Task number (Task 1: Implement Kanban Board Info-Only Split)
VERSION_BUILD = 1     # Build number (E4:S18:T01+1 - Board split into structured info and guide)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.4.18.1+1 = Development, Epic 4, Story 18, Task 1, Build 1 (Kanban board info-only split)
