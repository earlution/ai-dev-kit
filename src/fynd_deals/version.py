...
VERSION_TASK = 15     # Task number (T15: canonical RW step list traceability wiring)
VERSION_BUILD = 1     # Build number (first release for T15)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.2.1.15+1 = Development, Epic 2, Story 1, Task 15
