...
VERSION_BUILD = 2     # Build number (E5:S08:T02+2 - KB migration to Notion)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.5.8.2+2 = Development, Epic 5, Story 8, Task 2, Build 2 (E5:S08:T02: KB migration to Notion)
