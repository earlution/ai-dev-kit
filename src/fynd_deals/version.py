...
VERSION_TASK = 101    # Task number (T101: Update Kanban Workflow perpetual maintenance)
VERSION_BUILD = 43    # Build number (latest UKW/RW-k maintenance release)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.6.7.101+43 = Development, Epic 6, Story 7, Task 101
