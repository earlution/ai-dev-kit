...
VERSION_TASK = 13     # Task number (Task 13: Test PIR workflow with sample Story)
VERSION_BUILD = 1     # Build number (E2:S05:T13+1 - Story-level PIR workflow tested, significance evaluation validated)
