...
VERSION_TASK = 3      # Task number (T03: Kanban documentation consistency)
VERSION_BUILD = 0     # Build number (E7:S06:T03+0 – doc-init)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.7.6.3+0 = Development, Epic 7, Story 6, Task 3 (E7:S06:T03+0: Kanban documentation consistency doc-init)
