...
VERSION_TASK = 56     # Task number (T56: BR-056 RW ambiguous task identifier typo risk)
VERSION_BUILD = 1     # Build number (E6:S06:T56+1 – T56 task filed)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.6.6.56+1 = E6:S06:T56 – BR-056 RW ambiguous task identifier typo risk (task filed)
