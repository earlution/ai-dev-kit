...
VERSION_TASK = 5      # Task number (E2:S16:T05 — Markdown Documentation Maintenance perpetual lane)
VERSION_BUILD = 1     # Build number (RW -d E2:S16:T05 --art)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.2.16.5+1 = Development, Epic 2, Story 16, Task 5, Build 1
