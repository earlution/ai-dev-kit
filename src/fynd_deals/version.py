...
VERSION_BUILD = 1     # Build number (E4:S16:T06+1 - RC sign-off criteria defined, gap log reviewed, all acceptance criteria met)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.4.16.6+1 = Development, Epic 4, Story 16, Task 6, Build 1 (E4:S16:T06: RC sign-off criteria defined, gap log reviewed, all acceptance criteria met)
