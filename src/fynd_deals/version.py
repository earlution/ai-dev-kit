...
VERSION_BUILD = 4     # Build number (E7:S01:T05+4 - GitHub Actions Workflow Optimization)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.7.1.5+4 = Development, Epic 7, Story 1, Task 5, Build 4 (E7:S01:T05+4: GitHub Actions Workflow Optimization)
