...
VERSION_BUILD = 2     # Build number (E6:S01:T33+2 - Epic ordering fixed in kanban board, partial implementation complete)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.6.1.33+2 = Development, Epic 6, Story 1, Task 33, Build 2 (E6:S01:T33: Epic ordering fixed in kanban board, partial implementation complete)
