...
VERSION_BUILD = 6     # Build number (E9:S01:T08+6 - Task document update: T13 migrated from E6:S06 to E6:S07, SemVer mapping proposal documentation)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.9.1.8+6 = Development, Epic 9, Story 1, Task 8, Build 6 (Task document update: T13 migrated, SemVer mapping proposal documentation)
