...
VERSION_TASK = 1      # Task number (Task 1: Enumerate supported installation paths for Kanban)
VERSION_BUILD = 1     # Build number (E4:S17:T01+1 - Installation paths enumerated for Kanban package)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.4.17.1+1 = Development, Epic 4, Story 17, Task 1, Build 1 (Installation paths enumerated for Kanban package)
