...
VERSION_TASK = 14     # Task number (Task 14: Create PIR workflow reference documentation)
VERSION_BUILD = 1     # Build number (E2:S05:T14+1 - Comprehensive PIR workflow reference created)
