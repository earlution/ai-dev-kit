...
VERSION_TASK = 110    # Task number (T110: UKW fbuboard parity + drift/concurrency controls)
VERSION_BUILD = 1     # Build number (first release for T110)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.6.7.110+1 = Development, Epic 6, Story 7, Task 110
