...
VERSION_BUILD = 0     # Build number (E5:S01:T36+0 - Doc-init: FR-036 and task document created)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.5.1.36+0 = Development, Epic 5, Story 1, Task 36, Build 0 (E5:S01:T36: Doc-init: FR-036 and task document created)
