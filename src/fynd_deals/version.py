...
VERSION_EPIC = 4      # Epic number (Epic 4: FR/BR/UXR Governance and Intake)
VERSION_STORY = 19    # Story number within epic
VERSION_TASK = 2      # Task number (E4:S19:T02 — canonical supporting Kanban/FBU doc naming and terminology)
VERSION_BUILD = 1     # Build number (RW E4:S19:T02 --art)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.4.19.2+1 = Development, Epic 4, Story 19, Task 2, Build 1
