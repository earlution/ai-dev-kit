...
VERSION_TASK = 6      # Task number (Task 6: Git subtree backend implementation)
VERSION_BUILD = 1     # Build number (E6:S07:T06+1 - Git subtree backend implementation complete)
