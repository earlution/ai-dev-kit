...
VERSION_TASK = 7      # Task number (E5:S09:T07 — FR-071 Docusaurus site search / local index)
VERSION_BUILD = 1     # Build number (first release for T07)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.5.9.7+1 — E5:S09:T07: FR-071 local offline search, portal config, README, contract tests
