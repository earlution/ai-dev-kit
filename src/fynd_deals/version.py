...
VERSION_TASK = 3      # Task number (Task 3: Make Step 7 mandatory and blocking)
VERSION_BUILD = 1     # Build number (E2:S08:T03 complete - Step 7 hardened: mandatory and blocking)
