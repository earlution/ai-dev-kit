...
VERSION_TASK = 106    # Task number (T106: Windsurf Migration: .cursorrules to Workflow Equivalents)
VERSION_BUILD = 1     # Build number (E6:S07:T106+1 - Windsurf Migration implementation release)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.6.7.106+1 = Development, Epic 6, Story 7, Task 106, Build 1 (E6:S07:T106+1: Windsurf Migration implementation release)
