...
VERSION_TASK = 5      # Task number (Task 5: Create framework version tagging strategy)
VERSION_BUILD = 1     # Build number (E6:S01:T05+1 - Framework version tagging strategy document created)
