...
VERSION_BUILD = 3     # Build number (E7:S06:T16+3 – T16 review deliverable)

# Composite version string using RC.EPIC.STORY.TASK+BUILD schema
# Format: RC.EPIC.STORY.TASK+BUILD
# Example: 0.3.1.3+1 = Development, Epic 3, Story 1, Task 3, Build 1
# Current: 0.7.6.16+3 = Development, Epic 7, Story 6, Task 16 (E7:S06:T16+3: T16 review deliverable)
