...
**Structure:** All Kanban docs live under `docs/Project_Management/kanban/`:
...
See [`README.md`](README.md) for full structure details and `docs/Project_Management/rituals/policy/kanban-governance-policy.md` for governance.
