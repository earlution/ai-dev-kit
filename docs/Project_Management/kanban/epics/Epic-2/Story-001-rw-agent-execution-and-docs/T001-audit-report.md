...
**Current:** `docs/Changelog_and_Release_Notes/Changelog_Archive`  
...
**Current:** `docs/Project_Management/epics/overview/Epic {epic}/Epic-{epic}.md`  
...
**Current:** `docs/Project_Management/epics/overview/_index.md`  
...
**Current:** `docs/Project_Management/kanban/Epic 4/Story-3-*.md`  
...
changelog_archive_dir: "docs/Changelog_and_Release_Notes/Changelog_Archive"
