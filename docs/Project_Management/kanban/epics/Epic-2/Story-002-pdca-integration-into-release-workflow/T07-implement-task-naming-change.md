...
- Task naming policy: `docs/Project_Management/rituals/policy/kanban-governance-policy.md`
...
1. **Update Policy Documents:**
   ...
   - Update `docs/Project_Management/rituals/policy/kanban-governance-policy.md`
