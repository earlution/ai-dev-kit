...
**Depth:** 3-4 levels (`docs/Project_Management/kanban/epics/epic-{N}.md`)
...
**Depth:** 3 levels (`docs/Changelog_and_Release_Notes/Changelog_Archive/CHANGELOG_v{VERSION}.md`)
...
**Depth:** 3 levels (`docs/Engineering_and_Platform/Category/service-name.md`)
...
│   └── Changelog_Archive/
├── Project_Management/               # Core section
│   ├── kanban/
│   └── rituals/
...
|----------------|-------------------|----------|-------|
| `Architecture` | `docs/Architecture/` | `Standards_and_ADRs/` | Direct mapping |
| `Changelog_and_Release_Notes` | `docs/Changelog_and_Release_Notes/` | `Changelog_Archive/` | Direct mapping |
| `Project_Management` | `docs/Project_Management/` | `kanban/`, `rituals/` | Direct mapping |
| `Documentation` | `docs/Guides/` | `Getting_Started/`, `How_To/` | Consolidate into Guides |
| `Onboarding_and_Enablement` | `docs/Enablement/` | `Onboarding_and_Enablement/` | Direct mapping |
| `Engineering_and_Platform` | `docs/Engineering_and_Platform/` | `Services_and_Components/`, `Code_Conventions/` | Direct mapping |
...
| `Tooling_and_Integrations` | `docs/Engineering_and_Platform/` | `Tooling_and_Integrations/` | Move to Engineering_and_Platform |
| `Governance_and_Process` | `docs/Project_Management/` | `rituals/` | Consolidate into Project_Management |
...
- Create `docs/Architecture/`, `docs/Project_Management/`, `docs/Changelog_and_Release_Notes/`, `docs/Guides/`
- Use minimal categories (e.g., `Architecture/Standards_and_ADRs/`)

**Step 2: Add Optional Sections as Needed**
- Add `docs/Engineering_and_Platform/` when you have multiple services
...
**Examples:**
- ✅ `docs/Architecture/Standards_and_ADRs/dev-kit-versioning-policy.md` (3 levels)
- ✅ `docs/Project_Management/kanban/epics/epic-1.md` (4 levels, acceptable for Kanban)
- ❌ `docs/Project_Management/kanban/epics/epic-1/stories/story-1/tasks/task-1.md` (7 levels, too deep)

### 5.2 Exception Rule: 4th Level Only When Justified

**When 4th Level is Acceptable:**
- Epic-specific assets: `docs/Project_Management/kanban/epics/epic-1/assets/`
...
**Actions:**
- Create `docs/Architecture/Standards_and_ADRs/canonical-kb-pattern.md` (or similar)
...
- `docs/Architecture/Standards_and_ADRs/dev-kit-versioning-policy.md` – Versioning policy
