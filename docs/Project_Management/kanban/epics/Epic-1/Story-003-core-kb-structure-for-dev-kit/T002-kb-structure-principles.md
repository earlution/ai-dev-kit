...
#### Changelog (`docs/Changelog_and_Release_Notes/`)
...
- Examples: `Architecture/`, `Project_Management/`, `Changelog_and_Release_Notes/`, `Guides/`
...
- **Preferred pattern:** `docs/Architecture/Standards_and_ADRs/dev-kit-versioning-policy.md`, `docs/Changelog_and_Release_Notes/Changelog_Archive/CHANGELOG_v0.1.3.1+1.md`
...
- Example: `[Kanban Governance](../Project_Management/rituals/policy/kanban-governance-policy.md)`
...
- [Kanban Governance](../Project_Management/rituals/policy/kanban-governance-policy.md)
