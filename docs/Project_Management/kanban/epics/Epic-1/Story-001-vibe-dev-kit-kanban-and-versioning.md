...
- Provide a simple, repo-local Kanban structure under `docs/Project_Management/kanban/`.
...
- [x] Create `docs/Project_Management/kanban/_index.md` with:
...
- [x] Create `docs/Project_Management/kanban/Story-001-ai-dev-kit-kanban-and-versioning.md` (this file).
- [x] Include:
...
- [x] Document the decision in a local versioning policy under:
  - ✅ `docs/Architecture/Standards_and_ADRs/dev-kit-versioning-policy.md` (created and active)
