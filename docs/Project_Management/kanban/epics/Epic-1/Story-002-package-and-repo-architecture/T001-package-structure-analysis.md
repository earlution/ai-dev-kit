...
- **Key Files:**
  ...
  - `docs/Architecture/Standards_and_ADRs/versioning-policy.md` (version schema definition)
  - `docs/Architecture/Standards_and_ADRs/versioning-strategy.md` (versioning strategy)
...
- **Location:**
  - `workflow mgt/docs/Architecture/Standards_and_ADRs/versioning-policy.md`
