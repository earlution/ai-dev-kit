...
This document compares the `ai-dev-kit`'s local Kanban policy (`docs/Project_Management/rituals/policy/kanban-governance-policy.md`) and templates with the canonical framework policies (`packages/frameworks/kanban/policies/kanban-governance-policy.md` and templates).
...
### Dev-Kit Policy (`docs/Project_Management/rituals/policy/kanban-governance-policy.md`)
...
### Dev-Kit Epic Usage (Example: `docs/Project_Management/kanban/epics/Epic-3/Epic-3.md`)
...
### Dev-Kit Story Usage (Example: `docs/Project_Management/kanban/Story-001-dev-kit-alignment-with-versioning-framework.md`)
