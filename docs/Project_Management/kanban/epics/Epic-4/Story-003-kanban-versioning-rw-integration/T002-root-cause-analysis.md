...
**Location:** `docs/Architecture/Standards_and_ADRs/dev-kit-versioning-policy.md`
...
- `docs/Project_Management/kanban/Story-003-kanban-versioning-rw-integration/T002-kanban-versioning-validation.md` (validation report)
