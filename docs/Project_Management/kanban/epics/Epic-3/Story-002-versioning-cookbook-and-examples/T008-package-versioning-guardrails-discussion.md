...
**Bump Policy:** [Package Versioning Policy](../../docs/Architecture/Standards_and_ADRs/package-versioning-policy.md)
```
...
- **B:** Centralized `docs/Changelog_and_Release_Notes/Packages/`
