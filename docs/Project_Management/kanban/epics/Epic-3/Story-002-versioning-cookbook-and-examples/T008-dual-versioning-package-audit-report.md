...
- `docs/Documentation/Developer_Docs/vwmp/release-workflow-agent-execution.md`: Version history (1.0.0, 1.1.0, 1.2.0)
...
- `docs/Architecture/Standards_and_ADRs/versioning-policy.md`: Version history table
...
**Finding:** The dual-versioning strategy documented in `docs/Architecture/Standards_and_ADRs/dual-versioning-package-managers.md` is **not currently applied** to any packages in the repository.
...
- **Package Structure Analysis:** `docs/Project_Management/kanban/epics/Epic-1/Story-002-package-and-repo-architecture/T001-package-structure-analysis.md`
