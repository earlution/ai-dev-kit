...
- `docs/Architecture/Standards_and_ADRs/dev-kit-versioning-policy.md` - Dev-kit canonical ordering policy
- `docs/Project_Management/kanban/epics/Epic-3/Story-002-versioning-cookbook-and-examples.md` - Related changelog ordering work (Task 6)
