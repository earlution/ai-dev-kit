...
- `docs/Documentation/User_Docs/framework-dependency-post-template-setup-guide.md` - Setup process
...
**Kanban Links:**
- Epic: [To be created: `docs/Project_Management/kanban/epics/Epic-21/Epic-21.md`]
- Story: [To be created: `docs/Project_Management/kanban/epics/Epic-21/Story-001-internationalization-infrastructure.md`]
