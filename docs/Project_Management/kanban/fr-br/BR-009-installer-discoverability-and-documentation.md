...
3. **Manual Copying Problem:** Users manually copy `docs/Project_Management/kanban/epics/*` and get ai-dev-kit's project-specific content
...
**Actual Behavior:**
- Users manually copy files: `cp -r packages/frameworks/ai-dev-kit/docs/Project_Management/kanban/epics/* docs/Project_Management/kanban/epics/`
...
4. Manually copy Kanban structure: `cp -r packages/frameworks/ai-dev-kit/docs/Project_Management/kanban/epics/* docs/Project_Management/kanban/epics/`
