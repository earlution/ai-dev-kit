...
- [ ] **Criterion 2:** Detection utility created: `detect_existing_structure.py`
  - Scans `docs/Project_Management/kanban/epics/` (or configured path)
...
- **Task Migration:** `docs/Project_Management/kanban/_backup-pre-migration/TASK_MIGRATION_MAP.md`
