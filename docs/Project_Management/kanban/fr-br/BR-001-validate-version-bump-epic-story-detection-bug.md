...
- Example: `python validate_version_bump.py --story-file "docs/Project_Management/kanban/epics/Epic-3/stories/Story-003-versioning-integration-with-kanban-and-rw.md" --strict`
...
**Kanban Links:**
- Epic: [`docs/Project_Management/kanban/epics/Epic-2.md`](epics/Epic-2.md)
- Story: [`docs/Project_Management/kanban/epics/Epic-2/stories/Story-001-rw-agent-execution-and-docs.md`](epics/Epic-2/stories/Story-001-rw-agent-execution-and-docs.md)
- Task: [To be created]
...
- `docs/Architecture/Standards_and_ADRs/workflow-flaws-reference-guide.md`
