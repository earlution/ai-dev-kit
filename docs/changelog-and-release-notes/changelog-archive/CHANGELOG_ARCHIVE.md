...
### Fixed
- RW Step 7 (Auto-update Kanban Docs): Fixed critical bugs preventing board updates
  - Fixed story document path resolution (glob pattern matching)
  - Fixed Kanban board path resolution (absolute/relative path handling)
  - Fixed MoSCOW section updates (tasks now marked COMPLETE automatically)
  - Board updates now work correctly end-to-end

[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.5.1.34+2.md)
...
### Changed
- RW Step 7 (Auto-update Kanban Docs): Enhanced to update Kanban board on task completion
  ...
  - All acceptance criteria met (E5:S01:T36 complete)

[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.5.1.36+1.md)
...
### Added
- FR-037 repository task (E5:S01:T37): Create task for Kanban Policy Task Prioritisation and Queue/Stack
  - Task document and FR assignment added; FR-037 wired to E5:S01:T37
  - Implementation (governance policy and queue/stack rules) to be assigned by intake

[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.5.1.37+1.md)
...
### Added
- Doc-init / abstract space cheat sheet and story quick reference (E5:S01:T37)
  - Added a concise **doc-init / abstract space cheat sheet** to the dev-kit versioning policy, clarifying when to use `+0` vs `+1+`.
  - Wired a **quick reference** into the E3:S04 Numbering & Versioning package implementation review story.
  - Reinforced the relationship between FR/BR onboarding, Task docs, and abstract space usage.

[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.5.1.37+2.md)
...
### Added
- Policy alignment with Starborn Legacy patterns (E5:S01:T37)
  - Policy comparison proposal (Starborn vs ai-dev-kit)
  - Implementation Cycle (spec + TDD) as adoptable pattern and framework SoP
  - Changelog language reminder (no "Fixed" until verified)
  - Step 9.6: Check IDE-flagged problems (recommended before commit)
  - Top-of-file git reminder (commit/push only via RW)
  - Perpetual-task document update requirement in Kanban Governance

[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.5.1.37+3.md)
...
### Added
- Framing and configuration updates for numbering/versioning and workflow docs (E5:S01:T37)
  - Documented dual-version mental model (internal `RC.EPIC.STORY.TASK+BUILD` vs external SemVer).
  - Introduced SemVer mapping modes (registry-based epic/story vs simple global PATCH) at the framework level.
  - Defined a standard optional SemVer metadata pattern for embedding internal coordinates in tags.
  - Aligned dev-kit local policy, cookbook, RW/PVW agent guides, and README with release-first storytelling.

[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.5.1.37+4.md)
...
### Added
- Initial review release for AI Dev Kit project review and legacy clean-up (E5:S01:T39)
  - Created FR-039 and Task T39 to anchor the repository review and clean-up planning work in the FR Repo.
  - Added an initial project review report and high-level clean-up checklist under `ai-dev-kit-project-review.md`.
  - No behavioural changes to frameworks; this build documents planning and review artefacts only.

[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.5.1.39+1.md)
...
### Fixed
- UKW Board Disorganization (BR-033): Epic ordering fixed in kanban board
  - Epics now sorted numerically (E1-E11, E21, E24)
  - Epic 21 moved from after E4 to after E11
  - Epic 7 and Epic 8 moved from after E11 to after E6

### Changed
- Task E6:S01:T33 status updated from TODO to IN PROGRESS
- UKW execution guide updated with sorting requirements
- BR-033 fix attempt history documented

[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.6.1.33+2.md)
...
### Added
- Sorting utility script for kanban board (`sort_kanban_board.py`)
  - Automatically sorts epics numerically (canonical 1-23, then project-specific 24+)
  - Supports `--dry-run` mode for preview
  - Auto-detects board path from config

### Changed
- UKW execution guide updated with sorting utility usage instructions
- Task E6:S01:T33 implementation progress updated (Phase 2 complete)

[Detailed changelog](docs/changelog-and-release-notes/changelog-archive/CHANGELOG_v0.6.1.33+3.md)
