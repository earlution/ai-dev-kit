...
Some paths under `docs/documentation/user-docs/` support **both** book-style narrative and adoption workflows; **framework adoption** should treat [`INSTALL_IN_YOUR_PROJECT.md`](https://github.com/earlution/ai-dev-kit/blob/main/INSTALL_IN_YOUR_PROJECT.md) as the canonical first-run pointer unless a guide explicitly scopes brownfield work.
