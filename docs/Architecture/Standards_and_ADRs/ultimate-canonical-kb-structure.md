...
├── Project_Management/             # Project management, Kanban, governance
...
- `[Epic 1 Overview](Project_Management/kanban/epics/Epic-1/Epic-1.md)`
...
- 6-pillar structure exists directly under `docs/` (Architecture, Changelog, Project_Management, User_Guides, Developer_Documentation, knowledge)
