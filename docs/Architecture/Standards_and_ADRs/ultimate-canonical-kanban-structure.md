...
```
docs/Project_Management/kanban/epics/
├── Epic-1/
│   ├── Epic-1.md
│   ├── Story-001-project-foundation-and-setup/
...
- Epic directory: `docs/Project_Management/kanban/epics/Epic-{N}/`
...
- ai-dev-kit's actual Kanban in `docs/Project_Management/kanban/epics/`
