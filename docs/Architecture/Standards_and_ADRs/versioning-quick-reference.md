...
- **Full Cookbook:** `docs/Architecture/Standards_and_ADRs/dev-kit-versioning-cookbook.md`
...
- **Error Reference:** `docs/Architecture/Standards_and_ADRs/versioning-error-reference-guide.md`
