...
required:
  ...
  - Kanban structure: `docs/Project_Management/kanban/`
```
...
kanban:
  ...
  location: "docs/Project_Management/kanban/"
...
**Reference:** `docs/Project_Management/kanban/epics/Epic-4/Story-003-kanban-versioning-rw-integration/T002-kanban-versioning-validation.md`
...
**Reference:** `docs/Project_Management/kanban/epics/Epic-4/Story-003-kanban-versioning-rw-integration/T003-versioning-rw-validation.md`
...
**Reference:** 
- `docs/Project_Management/kanban/epics/Epic-4/Story-003-kanban-versioning-rw-integration/T004-rw-kanban-validation.md`
- `docs/Project_Management/kanban/epics/Epic-4/Story-003-kanban-versioning-rw-integration/T007-gap-resolution-summary.md`
...
- Files modified: `docs/Architecture/Standards_and_ADRs/dev-kit-kanban-versioning-rw-integration.md`
...
- Creates `docs/Changelog_and_Release_Notes/Changelog_Archive/CHANGELOG_v0.4.3.5+1.md`
...
kanban_structure:
  root: "docs/Project_Management/kanban/"
  epics: "docs/Project_Management/kanban/epics/Epic-{epic}.md"
  stories: "docs/Project_Management/kanban/epics/Epic-{epic}/stories/Story-{story}-*.md"
  board: "docs/Project_Management/kanban/kanban-board.md"
  index: "docs/Project_Management/kanban/_index.md"

changelog:
  main: "CHANGELOG.md"
  archive: "docs/Changelog_and_Release_Notes/Changelog_Archive/CHANGELOG_v{version}.md"
...
**Reference Documents:**
- T002: `docs/Project_Management/kanban/epics/Epic-4/Story-003-kanban-versioning-rw-integration/T002-kanban-versioning-validation.md`
- T003: `docs/Project_Management/kanban/epics/Epic-4/Story-003-kanban-versioning-rw-integration/T003-versioning-rw-validation.md`
- T004: `docs/Project_Management/kanban/epics/Epic-4/Story-003-kanban-versioning-rw-integration/T004-rw-kanban-validation.md`
- T007: `docs/Project_Management/kanban/epics/Epic-4/Story-003-kanban-versioning-rw-integration/T007-gap-resolution-summary.md`
...
- **Kanban Governance:** `docs/Project_Management/rituals/policy/kanban-governance-policy.md`
