...
**Examples:**
- ai-dev-kit source: `docs/Project_Management/kanban/epics/Epic-{N}/Story-{NNN}/`
- been-there: `docs/Project_Management/kanban/epics/Epic-{N}/Story-{NNN}/`
- dev-toolkit: `docs/Project_Management/kanban/epics/Epic-{N}/Story-{NNN}/`
- (all 10 projects)
