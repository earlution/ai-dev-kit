...
- **Directory Structure:** `docs/Project_Management/kanban/Epic X/` (with space, not hyphen)
...
- Structure: `docs/Project_Management/kanban/Epic X/Story-X.md`
...
├── Operations_and_SRE/
├── Project_Management/ (Kanban here)
...
**Kanban Files:**
- `docs/Project_Management/kanban/Epic X/` (Epics 1-22, with space in directory name)
