...
- ⚠️ Different KB structure (`docs/Project_Management/epics/overview/` vs `docs/Project_Management/kanban/epics/`)
...
- **Directory Structure:** `docs/Project_Management/epics/overview/Epic-XX/` (with zero-padding)
...
- Structure: `docs/Project_Management/epics/overview/Epic-09/E09-S01.md`
...
- **Document Types:** Architecture, Changelog, Design, Documentation, Narrative, Project_Management, Research, Reference_Materials
...
**Kanban Files:**
- `docs/Project_Management/epics/overview/Epic-XX/` (Epics 01-18, with zero-padding)
...
- `docs/Project_Management/` (epics/overview/, templates/)
- `docs/Research/`
