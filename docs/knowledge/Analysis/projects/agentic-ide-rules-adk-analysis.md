...
**Kanban Files:**
- `docs/Project_Management/kanban/epics/Epic-1/` through `Epic-10/` (Epics 1-9 framework, Epic 10 project)
- Multiple stories and tasks per epic
- Bug report: `docs/Project_Management/kanban/fr-br/BR-kanban-installation-issue.md`

**KB Files:**
- `docs/Architecture/Standards_and_ADRs/`
- `docs/Changelog_and_Release_Notes/`
- `docs/Documentation/User_Docs/`
- `docs/Guides/`
