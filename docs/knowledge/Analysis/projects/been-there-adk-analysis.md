...
2. **Correct KB Structure**
   ...
   - Proper directory organization: `docs/Project_Management/kanban/epics/`
...
- `docs/Project_Management/kanban/epics/Epic-20/` (project epic)
- Multiple stories and tasks per epic

**KB Files:**
- `docs/Architecture/Standards_and_ADRs/` (20+ ADRs)
