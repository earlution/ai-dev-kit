...
- Changelog Archive: `docs/Changelog_and_Release_Notes/Changelog_Archive/CHANGELOG_v{version}.md`
...
**Reference:** See `docs/Architecture/Standards_and_ADRs/doc-lifecycle-configuration.md` for complete configuration and classification rules.
```
...
3. **Update Kanban paths** (currently shows `docs/Project_Management/kanban/...` as templates)
