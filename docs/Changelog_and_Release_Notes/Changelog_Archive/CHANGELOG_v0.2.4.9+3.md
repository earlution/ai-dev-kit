...
- `docs/Architecture/Standards_and_ADRs/task-naming-migration-guide.md`
...
**Story Documents:**
- 46 story documents in `docs/Project_Management/kanban/epics/` (all updated to use `Exx:Sxx:Txx` format)
