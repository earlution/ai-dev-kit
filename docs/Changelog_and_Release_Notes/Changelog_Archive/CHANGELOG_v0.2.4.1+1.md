...
- Story scaffold and analysis scope for RW installer story:
  - `docs/Project_Management/kanban/epics/Epic-2/stories/Story-004-rw-installer-and-plug-and-play-adoption.md`
...
- **Previous RW releases:** `docs/Changelog_and_Release_Notes/Changelog_Archive/CHANGELOG_v0.2.3.6+2.md`, `CHANGELOG_v0.2.3.6+1.md`
