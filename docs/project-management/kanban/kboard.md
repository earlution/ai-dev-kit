...
- **E4:S19:T02** – FR-086: canonical supporting Kanban/FBU doc naming + `FBU` collective terminology - TODO (HIGH, canonical supporting-doc shorthand + collective terminology standardization while preserving individual `FR-`/`BR-`/`UXR-` identities) - [Task Document](epics/Epic-4/Story-019-fr-br-uxr-abstract-governance-and-intake/T02-canonical-supporting-kanban-fbu-doc-naming-and-fbu-collective-terminology-fr086.md) | [Story](epics/Epic-4/Story-019-fr-br-uxr-abstract-governance-and-intake.md) | Last modified: 2026-04-20 16:35 UTC
...
- **E5:S01:T31** – Multi-agent coordination feasibility investigation (FR-031) - TODO (C priority architecture exploration) - [Task Document](epics/Epic-5/Story-001-fr-repo/T31-multi-agent-coordination-feasibility-investigation.md) | [Story](epics/Epic-5/Story-001-fr-repo.md) | Last modified: 2026-04-20 15:52 UTC
- **E5:S01:T35** – Task template cross-wiring section (FR-035) - TODO (MEDIUM template quality) - [Task Document](epics/Epic-5/Story-001-fr-repo/T35-task-template-cross-wiring-section.md) | [Story](epics/Epic-5/Story-001-fr-repo.md) | Last modified: 2026-04-20 15:52 UTC
...
- **E5:S01:T56** – Standardize packaged workflow documentation and instructions (FR-056) - TODO (LOW packaging consistency) - [Task Document](epics/Epic-5/Story-001-fr-repo/T56-standardize-packaged-workflow-documentation-and-instructions.md) | [Story](epics/Epic-5/Story-001-fr-repo.md) | Last modified: 2026-04-20 15:52 UTC
- **E5:S01:T62** – Improve GitHub release installation experience (FR-062) - PROPOSED (LOW release UX) - [Task Document](epics/Epic-5/Story-001-fr-repo/T62-github-release-installation-experience.md) | [Story](epics/Epic-5/Story-001-fr-repo.md) | Last modified: 2026-04-20 15:52 UTC
...
- **E2:S16:T03** – Re-house workflow perpetual tasks and harden guardrails - IN PROGRESS (execute migration away from legacy `T101+` anchors) - [Task Document](epics/Epic-2/Story-016-perpetual-ongoing-workflow-operations/T03-rehouse-workflow-perpetual-tasks-and-harden-guardrails.md) | [Story](epics/Epic-2/Story-016-perpetual-ongoing-workflow-operations.md) | Last modified: 2026-04-20 18:20 UTC

- **E7:S01:T05** – Markdown Maintenance (Perpetual Task) - PERPETUAL (v0.7.1.5+2, Last updated: 2026-03-07) - [Task Document](epics/Epic-7/Story-001-codebase-maintenance-tasks/T05-markdown-maintenance-perpetual-task.md) | [Story](epics/Epic-7/Story-001-codebase-maintenance-tasks.md) | Last modified: 2026-04-20 15:52 UTC
