...
| Area | Role |
|------|------|
| [`portal/docusaurus.config.js`](../../../../portal/docusaurus.config.js) | Docs path, `exclude`, strict hooks |
| [`portal/sidebars.js`](../../../../portal/sidebars.js) | Autogenerated sections only — no fix without link/corpus strategy |
| Repository `docs/**/*.md` | Many relative links to root / `packages/` |
| Root [`INSTALL_IN_YOUR_PROJECT.md`](../../../../INSTALL_IN_YOUR_PROJECT.md) | Canonical adopter entry **outside** `docs/` |
...
- [FR-070](./FR-070-github-pages-documentation-site-deployment.md) — GitHub Pages deployment depends on green build.
