...
**Docs that echo this table:** [docusaurus corpus triage note](../../../maintenance/docusaurus-corpus-triage-fr-067.md) (Deferred outcomes — **FU-1** / **FU-2** / ~~**FU-3**~~), [portal README (repository root)](https://github.com/earlution/ai-dev-kit/blob/main/portal/README.md) (**FU-1** / strict links / **FU-3** anchors); **FU-2** (GitHub Releases) → [E6:S07:T103](../epics/Epic-6/Story-007-adk-implementation-analysis-and-package-management/T103-release-workflow-maintenance-perpetual-task.md) / [FR-041](./FR-041-perpetual-task-for-release-workflow-maintenance.md).
