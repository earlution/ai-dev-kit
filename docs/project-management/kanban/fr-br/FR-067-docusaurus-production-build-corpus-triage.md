...
| **FU-3** | **Strict broken-anchor checking** (`onBrokenAnchors` → **`throw`**) | **E5:S09:T08** enforced strict **href** checks; anchors still warn only. Optional hardening so bad `#fragment` links fail CI. | **Task:** [E5:S09:T10](../epics/Epic-5/Story-009-docusaurus-documentation-portal/T10-docusaurus-strict-broken-anchors-post-t08.md). |
