...
**Last Updated:** 2026-03-31 (**merge** `epic/7-documentation-maintenance` → **`main`**; tip **v0.7.0.2+2**; **E5:S09** go-live **v0.5.9.9+2** in archive)
**Version:** v0.7.0.2+2 *(from `src/fynd_deals/version.py` at board refresh)*
