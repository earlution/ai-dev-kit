...
**Last Updated:** 2026-03-31 (**RW -k E6:S06:T02** v0.6.6.2+9 — BR-038 / T02 on `epic/6-framework-management`)
**Version:** v0.6.6.2+9 *(from `src/fynd_deals/version.py` at board refresh)*
