...
- `docs/architecture/standards-and-adrs/versioning-policy.md`: Version history table
...
**Finding:** The dual-versioning strategy documented in `docs/architecture/standards-and-adrs/dual-versioning-package-managers.md` is **not currently applied** to any packages in the repository.
...
- **Package Structure Analysis:** `docs/project-management/kanban/epics/Epic-1/Story-002-package-and-repo-architecture/T001-package-structure-analysis.md`
