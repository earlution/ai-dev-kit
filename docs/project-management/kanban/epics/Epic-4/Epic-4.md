...
- [ ] **E4:S17 – Kanban Package Installation Evaluation** - IN PROGRESS (v0.4.17.2+1 – T02 complete: Fresh install steps validated)
  - Story: [`Story-017-kanban-package-installation-evaluation.md`](Story-017-kanban-package-installation-evaluation.md)
  - Tasks: T01 ✅ COMPLETE (v0.4.17.1+1), T02 ✅ COMPLETE (v0.4.17.2+1)
