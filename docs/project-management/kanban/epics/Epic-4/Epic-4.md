...
- [ ] **E4:S13 – Kanban Board Enhancement - MoSCoW Prioritized Task View** - IN PROGRESS (v0.4.13.4+3 – T04 COMPLETE: Packaged RW updated to v2.1.2 with BR-010 fix documentation)
  - Story: [`Story-013-kanban-board-moscow-prioritized-task-view.md`](Story-013-kanban-board-moscow-prioritized-task-view.md)
  - Tasks: T01 ✅ COMPLETE (v0.4.13.1+1), T04 ✅ COMPLETE (v0.4.13.4+3), T02-T03 TODO, T05-T06 TODO (after user verification)
